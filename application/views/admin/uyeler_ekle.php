...
<div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="contact-form">
                    <!-- Form -->
                    <form id="contact-us" method="post" action="<?=base_url()?>admin/uyeler/ekle_kaydet">
                        <!-- Left Inputs -->
                        <div class="col-xs-6 wow animated slideInLeft" data-wow-delay=".5s">
                            <table align="center" >
							<tr>
							<td>Adı Soyadi:</td>
                            <td><input type="text" name="adsoy" id="name" required="required" class="form" /></td> 
                            </tr>
							
							<tr>
							<td>Email:</td>
                            <td><input type="email" name="email" id="mail" required="required" class="form"  /></td>
                            </tr>
							<tr>
							<td>Şifre:</td>
                            <td><input type="password" name="sifre" id="subject" required="required" class="form" /></td>
							</tr>
					   ...
					   <td>
						...
						<button type="submit" id="submit" name="submit" class="form-btn semibold">Vazgeç</button>
                            ...
                            <button type="submit" id="submit" name="submit" class="form-btn semibold">Üye Ekle</button> </td></tr>
                        </Table>
                        <!-- Clear -->
                        <div class="clear"></div>
                    </form>
